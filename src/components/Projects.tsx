...
const projects = [
  {
    ...
    description:
      'Full-stack Movie finder application that displays movie information,rating,real-time movie details and OTT Streaming Availability.',
    tags: ['React', 'Typescript', 'python', 'flask', 'MySql', 'TMDB API', 'REST API'],
    links: {
  ...
  },
  {
    ...
    description:
      'Student Performance Analytics System is a Streamlit app built using Python and Pandas to analyze student results. It calculates total, average, grades, and pass/fail status, and shows class analytics, subject-wise analysis, toppers, weak students, and individual student reports.',
