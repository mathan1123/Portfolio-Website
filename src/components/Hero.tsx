        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <motion.div
            ...
            <p className="text-xl md:text-2xl text-gray-400 max-w-2xl leading-relaxed">
              Hello! I'm Mathan, a Computer Science graduate and aspiring Full-Stack Developer. I specialize in building modern web applications using frontend and backend technologies. I enjoy learning new tools, optimizing system performance, and working on challenging projects that enhance my problem-solving skills.
            </p>
            ...
            <div className="flex flex-wrap gap-4 pt-8">
              ...
              <motion.button
                ...
                className="px-8 py-4 rounded-lg bg-surface border border-white/10 text-white font-medium hover:bg-white/5 transition-colors flex items-center gap-2 disabled:opacity-50">
                {downloadingResume ? 'Downloading...' : 'Resume'} <Download size={20} />
              </motion.button>
            </div>
